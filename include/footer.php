                    ...
                    <div class="col-lg-6">
                        <div class="footer-counter-block">
                            <div class="count-outer count-box"> <span class="count-text" data-speed="3000"
                                    data-stop="25360">0</span><span class="plus">+</span> <span class="crl3">Raised For
                                    Donation</span> </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <div class=""> <input id="name" name="name"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="control-group">
                                                                        <div class=""> <input id="city" name="city"
                                                                                type="text"
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="control-group">
                                                                        <div class=""> <input id="postal-code"
                                                    ...
                                                    <form role="form" id="payment-form">
                                                        <div class="form-group">
                                                            <div class="input-group"> <input type="text"
                                                                    ...
                                                                    autofocus="" data-stripe="number"> <span
                                                                    class="input-group-block"> <i
                                                                        class="fa fa-credit-card"></i> </span> </div>
                                                        </div>
                                                        <div class="form-group"> <input type="text" class="form-control"
                                                                name="expMonth" placeholder="MM" required=""
                                                                data-stripe="exp_month"> </div>
                                                        <div class="form-group"> <input type="text" class="form-control"
                                                                name="expYear" placeholder="YY" required=""
                                                                data-stripe="exp_year"> </div>
                                                        <div class="form-group"> <input type="password"
                                                                class="form-control" name="cvCode" placeholder="CV"
                                                                required="" data-stripe="cvc"> </div>
                                                        <div class="row">
                                                            <div class="col-xs-12"> <button class="primary_btn"
                                                                    type="submit">Donate Now <i
                            ...
                            <div class="col-xl-3 col-md-6 wow animated fadeInUp" data-wow-delay="0.3s">
                                <div class="footer-widget-item mar-t50 s-two">
                                    ...
                                    <div class="footer-widget-news">
                                        <ul>
                                            <li>
                                                <div class="img-box"> <a href="blog-details.html"><img
                                            ...
                                            <li>
                                                <div class="img-box"> <img src="assets/images/resource/footer-2.jpg"
                                                        alt=""> </div>
                                                <div class="text-box">
                                                    <p><span class="far fa-calendar-alt"></span><a
                                                            href="blog-details.html">24th January 2024</a></p>
                                    ...
                                    <div class="footer-widget-newsletter">
                                        ...
                                        <div class="subscribe-box">
                                            <form class="subscribe-form" action="#">
                                                <div class="input-box"> <input type="email" name="email"
                                                        placeholder="Enter Email"> <button type="submit"><span
                                                            class="far fa-arrow-right"></span></button> </div>
                                            </form>
                                        </div>
            ...
            <div class="main-footer-bottom">
                <div class="theme_container">
                    <div class="main-footer-bottom-inner">
                        ...
                        <div class="text">
                            <p>Copyright © 2022 Masden. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
        </footer>
    </div><a href="# " class="back-to-top " data-wow-duration="1.0s " data-wow-delay="1.0s "> <i
            class="fas fa-angle-up "></i> </a>
    <script src="assets/js/charity.js"></script>
</body>
