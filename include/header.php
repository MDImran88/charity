...
<head>
    <meta charset="utf-8">
    <title>Help For All Charitable Trust </title>
    <link href="assets/css/charity.css" rel="stylesheet">
    <link href="assets/css/color-2.css" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="../../css2?family=Inter:wght@400;500;600;700&family=Roboto:wght@300;400;500;700&display=swap"
        rel="stylesheet">
                        ...
                        <div class="left-column">
                            <ul class="contact-info box-s-two">
                                <li><a href="mailto:hotline@gmail.com"><i
                                            class="far fa-envelope"><span>Email:</span></i>support@helpforallcharity.org</a>
                                </li>
                                <li class="crl-1">|</li>
                            </ul>
                        </div>
            ...
            <div class="header-upper">
                <div class="header-container-box">
                    <div class="inner-container">
                        <div class="left-column">
                            <div class="logo"> <a href="index.php"><img src="assets/images/logo-light-2.png" alt=""> </a>
                            </div>
                            <div class="nav-outer">
                                ...
                                <nav class="main-menu navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation">
                                            ...
                                            <li><a href="area-focus.php">Area Focus</a></li>
            ...
            <div class="sticky-header">
                <div class="header-upper">
                    <div class="header-container-box">
                        <div class="inner-container">
                            <div class="left-column">
                                <div class="logo"> <a href="index.php"><img src="assets/images/logo-light.png"
                                            alt=""></a> </div>
                                <div class="nav-outer">
                                    <div class="mobile-nav-toggler"><img src="assets/images/icons/icon-bar.png" alt="">
                                    </div>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="footer-widget-item recent-news-widget widget">
                        ...
                        <div class="footer-widget-news">
                            <ul>
                                <li>
                                    <div class="img-box"> <img src="assets/images/resource/footer-1.jpg" alt=""> </div>
                                    <div class="text-box">
                                        <p><span class="far fa-calendar-alt"></span>24th January 2021</p>
                                        <h6><a href="blog-details.php">We can build anything ni <br>hill ground or
                                                building.</a></h6>
                                    </div>
                                </li>
                                <li>
                                    <div class="img-box"> <img src="assets/images/resource/footer-2.jpg" alt=""> </div>
                                    <div class="text-box">
                                        <p><span class="far fa-calendar-alt"></span>24th January 2021</p>
                                        <h6><a href="blog-details.php">We can build anything ni <br>hill ground or
                                                building.</a></h6>
                    ...
                    <form method="post" action="index.php">
                        <div class="form-group">
                            <fieldset> <input type="search" class="form-control" name="search-input" value=""
                                    placeholder="Type & Enter" required=""> </fieldset>
                        </div>
                    </form>
                </div>
            </div>
